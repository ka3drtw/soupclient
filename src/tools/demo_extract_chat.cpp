...
static int ExtractDemoChat(const char *pDemoFilePath, IGameStorage *pStorage)
{
	...
	if(DemoPlayer.Load(pStorage, nullptr, pDemoFilePath, IGameStorage::TYPE_ALL_OR_ABSOLUTE) == -1)
	{
