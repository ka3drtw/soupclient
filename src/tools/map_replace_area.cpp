...
bool ReplaceArea(IGameStorage *, const char[3][64], const float[][2][2]);
bool OpenMaps(IGameStorage *, const char[3][64], CDataFileReader[2], CDataFileWriter &);
...
int main(int argc, const char *argv[])
{
	...
	IGameStorage *pStorage = CreateLocalStorage();
...
bool ReplaceArea(IGameStorage *pStorage, const char aaMapNames[3][64], const float aaaGameAreas[][2][2])
{
...
bool OpenMaps(IGameStorage *pStorage, const char aaMapNames[3][64], CDataFileReader aInputMaps[2], CDataFileWriter &OutputMap)
{
	for(int i = 0; i < 2; i++)
	{
		if(!aInputMaps[i].Open(pStorage, aaMapNames[i], IGameStorage::TYPE_ABSOLUTE))
		{
	...
	if(!OutputMap.Open(pStorage, aaMapNames[2], IGameStorage::TYPE_ABSOLUTE))
	{
