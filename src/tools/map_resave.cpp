...
static int ResaveMap(const char *pSourceMap, const char *pDestinationMap, IGameStorage *pStorage)
{
	CDataFileReader Reader;
	if(!Reader.Open(pStorage, pSourceMap, IGameStorage::TYPE_ABSOLUTE))
	{
