...
void Process(IGameStorage *pStorage, const char *pMapName, const char *pConfigName)
{
	CLineReader LineReader;
	if(!LineReader.OpenFile(pStorage->OpenFile(pConfigName, IOFLAG_READ, IGameStorage::TYPE_ABSOLUTE)))
	{
	...
	Reader.Open(pStorage, pMapName, IGameStorage::TYPE_ABSOLUTE);
