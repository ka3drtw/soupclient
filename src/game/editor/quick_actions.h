...
REGISTER_QUICK_ACTION(
	SaveAs,
	"Save As",
	[&]() { InvokeFileDialog(IGameStorage::TYPE_SAVE, FILETYPE_MAP, "Save map", "Save As", "maps", true, CEditor::CallbackSaveMap, this); },
	ALWAYS_FALSE,
	ALWAYS_FALSE,
	DEFAULT_BTN,
...
REGISTER_QUICK_ACTION(
	AddImage,
	"Add Image",
	[&]() { InvokeFileDialog(IGameStorage::TYPE_ALL, FILETYPE_IMG, "Add Image", "Add", "mapres", false, AddImage, this); },
	ALWAYS_FALSE,
	ALWAYS_FALSE,
	DEFAULT_BTN,
