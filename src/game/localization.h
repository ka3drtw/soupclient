...
public:
	void LoadIndexfile(class IGameStorage *pStorage, class IConsole *pConsole);
	...
	bool Load(const char *pFilename, class IGameStorage *pStorage, class IConsole *pConsole);
