...
#include "components/soup/freeze_kill.h"
#include "components/soup/playerpics.h"
#include "components/soup/outlines.h"
#include "components/soup/player_indicator.h"
#include "components/soup/rainbow.h"
#include "components/soup/skinprofiles.h"
#include "components/soup/statusbar.h"
#include "components/soup/soup.h"
#include "components/soup/trails.h"
#include "components/soup/verify.h"
#include "components/soup/warlist.h"
...
public:
    ...
    CControls *Controls() { return &m_Controls; }
    const CControls *Controls() const { return &m_Controls; }
	CCamera m_Camera;
	CChat m_Chat;
	CMotd m_Motd;
...
public:
	...
	class IGameStorage *Storage() const { return m_pStorage; }
