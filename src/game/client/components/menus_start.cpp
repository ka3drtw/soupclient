...
void CMenus::RenderStartMenu(CUIRect MainView)
{
	...
	static CButtonContainer s_TikTokButton;
	if(DoButton_Menu(&s_TikTokButton, Localize("TikTok"), 0, &Button, 0, IGraphics::CORNER_ALL, 5.0f, 0.0f, ColorRGBA(0.996f, 0.173f, 0.333f, 0.44f)))
	{
	...
	ExtMenu.HSplitBottom(5.0f, &ExtMenu, 0); // little space
	ExtMenu.HSplitBottom(20.0f, &ExtMenu, &Button);
	static CButtonContainer s_YouTubeButton;
	if(DoButton_Menu(&s_YouTubeButton, Localize("YouTube"), 0, &Button, 0, IGraphics::CORNER_ALL, 5.0f, 0.0f, ColorRGBA(1.0f, 0.0f, 0.0f, 0.44f)))
	{
	...
	if(DoButton_Menu(&s_DiscordButton, Localize("Discord"), 0, &Button, 0, IGraphics::CORNER_ALL, 5.0f, 0.0f, ColorRGBA(0.345f, 0.396f, 0.949f, 0.44f)))
	{
		Client()->ViewLink(Localize("https://dsc.gg/souptw"));
	}

	ExtMenu.HSplitBottom(5.0f, &ExtMenu, 0); // little space
	ExtMenu.HSplitBottom(20.0f, &ExtMenu, &Button);
	static CButtonContainer s_WebsiteButton;
	if(DoButton_Menu(&s_WebsiteButton, Localize("Website"), 0, &Button, 0, IGraphics::CORNER_ALL, 5.0f, 0.0f, ColorRGBA(0.992f, 0.706f, 0.227f, 0.44f)))
	{
