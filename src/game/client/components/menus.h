...
#include <game/client/components/soup/warlist.h>
...
private:
	...
	// found in menus_soup.cpp
	void RenderSettingsSoupClient(CUIRect MainView);
	void RenderSettingsSoupClientSettngs(CUIRect MainView);
