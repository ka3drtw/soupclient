...
public:
	...
	virtual int LoadOpus(const char *pFilename, int StorageType = IGameStorage::TYPE_ALL) = 0;
	virtual int LoadWV(const char *pFilename, int StorageType = IGameStorage::TYPE_ALL) = 0;
