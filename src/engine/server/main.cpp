...
int main(int argc, const char **argv)
{
	...
	IGameStorage *pStorage = CreateStorage(IGameStorage::EInitializationType::SERVER, argc, argv);
	if(!pStorage)
	{
	...
	pStorage->GetCompletePath(IGameStorage::TYPE_SAVE, aBufName, aBuf, sizeof(aBuf));
	...
	if(pStorage->FileExists(AUTOEXEC_SERVER_FILE, IGameStorage::TYPE_ALL))
	{
