...
class IGameStorage : public IInterface
{
...
extern IGameStorage *CreateStorage(IGameStorage::EInitializationType InitializationType, int NumArgs, const char **ppArguments);
extern IGameStorage *CreateLocalStorage();
extern IGameStorage *CreateTempStorage(const char *pDirectory);
