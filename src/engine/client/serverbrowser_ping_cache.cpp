...
public:
	...
	CServerBrowserPingCache(IConsole *pConsole, IGameStorage *pStorage);
...
CServerBrowserPingCache::CServerBrowserPingCache(IConsole *pConsole, IGameStorage *pStorage) :
	m_pConsole(pConsole)
{
...
IServerBrowserPingCache *CreateServerBrowserPingCache(IConsole *pConsole, IGameStorage *pStorage)
{
