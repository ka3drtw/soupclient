...
IServerBrowserHttp *CreateServerBrowserHttp(IEngine *pEngine, IGameStorage *pStorage, IHttp *pHttp, const char *pPreviousBestUrl)
{
	...
	if(LineReader.OpenFile(pStorage->OpenFile("ddnet-serverlist-urls.cfg", IOFLAG_READ, IGameStorage::TYPE_ALL)))
	{
