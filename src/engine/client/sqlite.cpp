...
CSqlite SqliteOpen(IConsole *pConsole, IGameStorage *pStorage, const char *pPath)
{
	char aFullPath[IO_MAX_PATH_LENGTH];
	pStorage->GetCompletePath(IGameStorage::TYPE_SAVE, pPath, aFullPath, sizeof(aFullPath));
