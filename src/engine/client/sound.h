...
class CSound : public IEngineSound
{
	...
	IGameStorage *m_pStorage = nullptr;
...
public:
	...
	int LoadOpus(const char *pFilename, int StorageType = IGameStorage::TYPE_ALL) override REQUIRES(!m_SoundLock);
	int LoadWV(const char *pFilename, int StorageType = IGameStorage::TYPE_ALL) override REQUIRES(!m_SoundLock);
