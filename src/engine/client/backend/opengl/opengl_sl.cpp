...
bool CGLSL::LoadShader(CGLSLCompiler *pCompiler, IGameStorage *pStorage, const char *pFile, int Type)
{
	if(m_IsLoaded)
		return true;
	...
	if(LineReader.OpenFile(pStorage->OpenFile(pFile, IOFLAG_READ, IGameStorage::TYPE_ALL)))
	{
