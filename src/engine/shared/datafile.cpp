...
bool CDataFileReader::Open(class IGameStorage *pStorage, const char *pFilename, int StorageType)
{
...
bool CDataFileWriter::Open(class IGameStorage *pStorage, const char *pFilename, int StorageType)
{
