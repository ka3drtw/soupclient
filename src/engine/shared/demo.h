...
public:
	...
	int Start(class IGameStorage *pStorage, class IConsole *pConsole, const char *pFilename, const char *pNetversion, const char *pMap, const SHA256_DIGEST &Sha256, unsigned MapCrc, const char *pType, unsigned MapSize, unsigned char *pMapData, IOHANDLE MapFile, DEMOFUNC_FILTER pfnFilter, void *pUser);
...
public:
	...
	int Load(class IGameStorage *pStorage, class IConsole *pConsole, const char *pFilename, int StorageType);
	unsigned char *GetMapData(class IGameStorage *pStorage);
	bool ExtractMap(class IGameStorage *pStorage);
	int Play();
	void Pause() override;
	...
	bool GetDemoInfo(class IGameStorage *pStorage, class IConsole *pConsole, const char *pFilename, int StorageType, CDemoHeader *pDemoHeader, CTimelineMarkers *pTimelineMarkers, CMapInfo *pMapInfo, IOHANDLE *pFile = nullptr, char *pErrorMessage = nullptr, size_t ErrorMessageSize = 0) const override;
...
{
	IConsole *m_pConsole;
	IGameStorage *m_pStorage;
	class CSnapshotDelta *m_pSnapshotDelta;

public:
	virtual void Init(class CSnapshotDelta *pSnapshotDelta, class IConsole *pConsole, class IGameStorage *pStorage);
