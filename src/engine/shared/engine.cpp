...
class CEngine : public IEngine
{
	...
	static void Con_DbgLognetwork(IConsole::IResult *pResult, void *pUserData)
	{
		...
		else
		{
			...
			CNetBase::OpenLog(pEngine->m_pStorage->OpenFile(aFilenameSent, IOFLAG_WRITE, IGameStorage::TYPE_SAVE),
				pEngine->m_pStorage->OpenFile(aFilenameRecv, IOFLAG_WRITE, IGameStorage::TYPE_SAVE));
