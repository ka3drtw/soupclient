...
public:
	...
	void WriteToFile(IGameStorage *pStorage, const char *pDest, int StorageType);
...
inline std::unique_ptr<CHttpRequest> HttpGetFile(const char *pUrl, IGameStorage *pStorage, const char *pOutputFile, int StorageType)
{
