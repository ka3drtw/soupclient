...
public:
	...
	bool Open(class IGameStorage *pStorage, const char *pFilename, int StorageType);
	bool Close();
...
public:
	...
	bool Open(class IGameStorage *pStorage, const char *pFilename, int StorageType = IGameStorage::TYPE_SAVE);
